...
eval("// Imports\nvar ___CSS_LOADER_API_IMPORT___ = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\nexports = ___CSS_LOADER_API_IMPORT___(false);\n// Module\nexports.push([module.i, \".hidden {汉  display: none !important;汉}汉汉.queue_entry > span:first-of-type {汉  margin-left: 5px;汉}汉汉.media-container {汉  display: inline-block;汉  overflow: hidden;汉}汉汉.media-msg {汉  max-width: 200px;汉  max-height: 200px;汉}汉汉.image-msg {汉  transition: 0.2s all;汉  cursor: zoom-in;汉}汉.image-msg:hover {汉  transform: scale(1.01);汉}汉汉.big-emote {汉  max-width: 300px !important;汉  max-height: 300px !important;汉}汉汉.gif-dialog {汉  display: flex;汉  justify-content: center;汉  flex-direction: column;汉  width: 200px;汉  height: 250px;汉}汉.gif-dialog .gif-container {汉  display: flex;汉  justify-content: center;汉  align-items: center;汉  width: 100%;汉  height: 200px;汉  overflow: hidden;汉  border: 1px dotted white;汉}汉.gif-dialog button {汉  border-style: solid;汉  border-width: 1px;汉  border-right: 3px;汉  background-color: #ffffff;汉  transition: border-width 0.1s;汉  color: #000000;汉}汉.gif-dialog button:hover {汉  border-width: 3px;汉}汉.gif-dialog .next-button {汉  width: 100%;汉  height: 25px;汉  border-color: #fbff00;汉  margin-bottom: 2px;汉}汉.gif-dialog .btn-container {汉  display: flex;汉  justify-content: space-between;汉  width: 100%;汉  height: 25px;汉}汉.gif-dialog .btn-container button {汉  width: 50%;汉}汉.gif-dialog .btn-container .cancel-button {汉  border-color: #f36666;汉  margin-right: 2px;汉}汉.gif-dialog .btn-container .confirm-button {汉  border-color: #02fc00;汉}汉汉.image-preview {汉  position: fixed;汉  top: 0;汉  left: 0;汉  z-index: 9999;汉  width: 100vw;汉  height: 100vh;汉  background-color: rgba(0, 0, 0, 0.4);汉  display: flex;汉  align-items: center;汉  justify-content: center;汉  cursor: zoom-out;汉}汉.image-preview img {汉  max-width: 80%;汉  max-height: 80%;汉}汉汉.gif-results-container {汉  position: relative;汉  width: 100%;汉  margin-top: 5px;汉  padding-top: 30px;汉}汉.gif-results-container button {汉  position: absolute;汉  right: 0;汉  top: 0;汉  width: 25px;汉  height: 25px;汉  color: #000000;汉  background-color: #ffffff;汉  border: 1px solid #ff7777;汉  border-radius: 4px;汉  transition: background-color, color 0.1s;汉}汉.gif-results-container button:hover {汉  background-color: #ff7777;汉  color: #ffffff;汉}汉.gif-results-container .gif-error-msg {汉  border: 1px solid #ff7777;汉  display: inline-block;汉  padding: 5px 5px 5px 5px;汉}汉.gif-results-container .results {汉  display: flex;汉  align-items: center;汉  justify-content: space-between;汉  flex-wrap: wrap;汉  width: 100%;汉  height: 200px;汉  overflow-y: scroll;汉}汉.gif-results-container .results .gif-search-result {汉  display: flex;汉  align-items: center;汉  justify-content: center;汉  width: 150px;汉  height: 150px;汉  margin-bottom: 5px;汉  border: 2px solid #ffffff;汉  border-radius: 4px;汉}汉.gif-results-container .results .gif-search-result:hover {汉  cursor: pointer;汉  border-color: #35d035;汉}汉.gif-results-container .results .gif-search-result img {汉  max-width: 100%;汉  max-height: 100%;汉}\", \"\"]);\n// Exports\nmodule.exports = exports;\n\n\n//# sourceURL=webpack:///./style/index.scss?./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js");
